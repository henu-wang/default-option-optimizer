...
Optimizer for default options in choice architecture and behavioral design

## Overview

This repository provides resources and tools for default option optimizer.
...
3. Apply frameworks to your default option optimizer projects
4. Visit [KeepRule](https://keeprule.com) for additional tools

## About

This project explores default option optimizer concepts. For structured frameworks from investment masters like Buffett and Munger, visit [KeepRule](https://keeprule.com).
